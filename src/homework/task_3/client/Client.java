...
public class Client extends AddressInfo {
    ...
    public static Client client_1 = new Client("David", "Metrovaj", "4856BB78",
            ...
            "Oliebaan", 45, 1);
    static BaseCart belCart1Client_1 = new BelCard(1085_1504_0000_1587l, 445, 3789.65, 0, BelCard.limit, BelCard.commission);
    static BaseCart belCart2Client_1 = new BelCard(1246_0780_0000_1474l, 702, 0.04, 1, BelCard.limit, BelCard.commission);
    static BaseCart visaCard1Client_1 = new VisaCard(1789_7933_0011_1452l, 214, 623.12, 2, VisaCard.limit, VisaCard.commission);
    static BaseCart visaCard2Client_1 = new VisaCard(2236_5202_4111_3412l, 614, 1102.00, 3, VisaCard.limit, VisaCard.commission);
    static BaseCart masterCard1Client_1 = new MasterCard(3214_7851_0000_4158l, 178, 102.3, 4, MasterCard.limit, MasterCard.commission);
    static BaseCart masterCard2Client_1 = new MasterCard(3408_1483_0000_3491l, 324, 505, 5, MasterCard.limit, MasterCard.commission);
